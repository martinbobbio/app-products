...
class RegisterPage extends StatelessWidget {
  ...
  Widget _createRegisterForm(BuildContext context) {
    ...
    return SingleChildScrollView(
      child: Column(
        children: <Widget>[
          ...
          FlatButton(child: Text('Already has account'), onPressed: () => Navigator.pushReplacementNamed(context, 'login')),
  ...
  _register(UserBloc bloc, BuildContext context) async {
    final data = await userProvider.newUser(bloc.email, bloc.password);
